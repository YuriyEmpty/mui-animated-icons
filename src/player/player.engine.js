export const EngineModule = function() {
    "use strict";
    ...
    var O = Math.sin, S = Math.cos, E = Math.acos, P = Math.asin, j = Math.tan, M = Math.atan2, B = Math.PI / 180,
        I = 180 / Math.PI, T = Math.sqrt, N = function() {
            function t() {
            ...
            return o(t, [ {
                ...
                value: function(t, e) {
                    if(e %= 360, (t %= 360) || e) {
                        var n = this.m, r = n[0], i = n[1], o = n[2], u = n[3];
                        t && (t = j(t * B), n[2] += r * t, n[3] += i * t), e && (e = j(e * B), n[0] += o * e, n[1] += u * e), this.w = this.s = this.i = null
                    }
                    return this
                }
            }, {
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                        e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n = this.m,
                        r = n[0] * n[0] + n[1] * n[1], i = [ [ n[0], n[1] ], [ n[2], n[3] ] ], o = T(r);
                    if(0 === o) return {
                        origin: {
                            x: g(n[4]),
                            y: g(n[5])
                    ...
                    i[1][0] /= l, i[1][1] /= l, a /= l;
                    var s = 0;
                    return i[1][1] < 0 ? (s = E(i[1][1]) * I, i[0][1] < 0 && (s = 360 - s)) : s = P(i[0][1]) * I, u && (s = -s), a = M(a, T(i[0][0] * i[0][0] + i[0][1] * i[0][1])) * I, u && (a = -a), {
                        origin: {
                            x: g(n[4]),
                            y: g(n[5])
                        },
    ...
    function K(t, e, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], i = e.length - 1;
    ...
    function et(t, e, r, i, o) {
        var u, a = "@" === r[0], l = "#" === r[0], s = W[r], f = R;
        switch(a ? (u = r.substr(1), r = u.replace(H, Q)) : l && (r = r.substr(1)), n(s)) {
            case"function":
                if(f = s(i, o, K, J, r, a, e, t), l) return f;
                break;
            case"string":
                f = Z(i, X(s));
                break;
            case"object":
                if((f = Z(i, X(s.i), s.f)) && "function" == typeof s.u) return s.u(e, f, r, a, t)
        }
        return f ? function(t, e, n) {
            if(arguments.length > 3 && void 0 !== arguments[3] && arguments[3]) return t instanceof $ ? function(r) {
    ...
    function it(t, e) {
        ...
        return a ? (n = a, r = e.settings, i = r.duration, o = n.length, u = null, function(t, e) {
            var a = r.iterations || 1 / 0, l = (r.alternate && a % 2 == 0) ^ r.direction > 0 ? i : 0, s = t % i,
                f = 1 + (t - s) / i;
            e *= r.direction, r.alternate && f % 2 == 0 && (e = -e);
            var c = !1;
            if(f > a) s = l, c = !0, -1 === r.fill && (s = r.direction > 0 ? 0 : i); else if(e < 0 && (s = i - s), s === u) return !1;
            u = s;
    ...
    function lt(t) {
        ...
        return !t || t % e ? t % e : [ 0, 1 ].includes(e) ? e : lt(t / e, e)
    }

    function st(t, e, n) {
        if(t && t.length) {
            var r = ut(n), i = lt(r) + 5, o = at(t, lt(r, 5), i);
            return o = o.replace(/\x7c$/g, "==").replace(/\x2f$/g, "="), o = function(t, e, n) {
                var r = +("0x" + t.substring(0, 4));
                t = t.substring(4);
                for(var i = ut(e, r) % r + n % 27, o = [], u = 0; u < t.length; u += 2) if("|" !== t[u]) {
    ...
    var ft = [ {
        ...
        function t(e, n) {
            var i = this, o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null;
        ...
        return o(t, [ {
                ...
                this._id = window.requestAnimationFrame((function i(o) {
                    if(e._rollingBack) {
                        ...
                        if(u > e.duration && n !== 1 / 0) {
                            var a = !!e.alternate && u / e.duration % 2 > 1, l = u % e.duration;
                            u = (l += a ? e.duration : 0) || e.duration
                        }
                        var s = (e.fps ? 1e3 / e.fps : 0) * e.speed, f = Math.max(0, u);
            ...
            key: "_start",
            value: function() {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0, n = -1 / 0,
                    r = null, i = {};
                this._running = !0;
                var o = function o(u) {
                    null == r && (r = u);
                    var a = Math.round((u - r) * t.speed + e), l = (t.fps ? 1e3 / t.fps : 0) * t.speed;
            ...
            key: "build",
            value: function(t, e) {
                delete t.animationSettings, t.options = st(t.options, t.root, "91c80d77"), t.animations.map((function(e) {
                    e.settings = st(e.s, t.root, "91c80d77"), delete e.s, t.animationSettings || (t.animationSettings = e.settings)
                }));
                var n = t.version;
                if(!(t = ot(t, e))) return null;
                var r = t.options || {}, i = new this(t.animations, t.animationSettings, n);
            ...
            key: "init",
            value: function() {
                var t = this, e = window.__SVGATOR_PLAYER__ && window.__SVGATOR_PLAYER__["91c80d77"];
    ...
    !function() {
        ...
        window.requestAnimationFrame || (window.requestAnimationFrame = function(e) {
            var n = Date.now(), r = Math.max(0, 16 - (n - t)), i = window.setTimeout((function() {
                e(n + r)
            }), r);
            return t = n + r, i
    ...
    var ht = function() {
        function t(e, n, i) {
            ...
            var o = function(t) {
                var e, n, r,
                    i = t && 1 === (null === (e = t.ownerDocument) || void 0 === e || null === (n = e.childNodes) || void 0 === n ? void 0 : n.length) && window.parent !== window,
                    o = {
                        el: t,
                        window: window
                    };
            ...
            n = Math.max(1, n || 1), n = Math.min(n, 100), this.el = o.el, this._handlers = [], this.onThresholdChange = i && i.call ? i : function() {
            }, this.thresholdPercent = n || 1, this.currentVisibility = null, this.visibilityCalculator = function(t, e) {
                var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : n, r = !1, i = null,
                    o = function() {
                        ...
                        r = !1;
                        var h = t.getBoundingClientRect(), v = Math.min(h.height, Math.max(0, o - h.top)),
                            d = Math.min(h.height, Math.max(0, h.bottom - u)),
                            y = Math.min(h.width, Math.max(0, a - h.left)),
                            g = Math.min(h.width, Math.max(0, h.right - l)), p = (h.height - v - d) / h.height,
                            m = (h.width - y - g) / h.width, b = Math.round(p * m * 100);
                        null !== i && i === b || (i = b, e(b))
                    };
                return function(t) {
        ...
        return o(t, [ {
            ...
            value: function(t) {
                var e = this.currentVisibility >= this.thresholdPercent, n = t >= this.thresholdPercent;
    ...
    function _t(t) {
        var e = function() {
            ...
            return t && t.style ? (t.style.position = "absolute", t.style.opacity = "0.01", t.style.zIndex = "-9999", t.style.left = "-9999px", t.style.width = "1px", t.style.height = "1px", kt = { svg: t }) : {}
        }().svg;
    ...
    function Ot(t, e, n, r) {
        var i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, o = xt(t, e, n, r), u = At(o);
        try {
            return u(i)
        } catch(t) {
            return null
    ...
    function Bt(t, e, n, r) {
        var i = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], o = Ot(t, e, null, n, r);
        return o || (o = {
            x: jt(t.x, e.x, n.x, r),
            y: jt(t.y, e.y, n.y, r)
        }), i && (o.a = It(t, e, n, r)), o
    ...
    function Rt(t, e, n, r, i) {
        var o = arguments.length > 5 && void 0 !== arguments[5] && arguments[5], u = Ot(t, e, n, r, i);
        return u || (u = {
            x: Tt(t.x, e.x, n.x, r.x, i),
            y: Tt(t.y, e.y, n.y, r.y, i)
        }), o && (u.a = Ft(t, e, n, r, i)), u
    }
    ...
    function Ct(t, e, n) {
        ...
        if(Lt(e)) {
            ...
            if(qt(e)) return Vt(n) ? Rt(e, e.end, n.start, n, t, r) : Bt(e, e.end, n, t, r);
            if(Vt(n)) return Bt(e, n.start, n, t, r)
        }
        return Et(e, n, t, r)
    }
    ...
    var zt = {
        ...
        i: function(t, e, r) {
            ...
            if(1 === t) return r;
            var i = e.length;
            if(i !== r.length) return R(t, e, r);
            for(var o, u = new Array(i), a = 0; a < i; a++) {
                if((o = n(e[a])) !== n(r[a])) return R(t, e, r);
                if("number" === o) u[a] = F(t, e[a], r[a]); else {
                    if(e[a] !== r[a]) return R(t, e, r);
                    u[a] = e[a]
                }
            }
            return u
        ...
        i: function(t, e, n) {
            var r, i, o, u = e.length, a = n.length;
            if(u !== a) if(0 === u) e = Y(u = a, 0); else if(0 === a) a = u, n = Y(u, 0); else {
                var l = (o = (r = u) * (i = a) / function(t, e) {
                    for(var n; e;) n = e, e = t % e, t = n;
                    return t || 1
                }(r, i)) < 0 ? -o : o;
                e = U(e, Math.floor(l / u)), n = U(n, Math.floor(l / a)), u = a = l
            }
            for(var s = [], f = 0; f < u; f++) s.push(g(C(t, e[f], n[f])));
            return s
        }
    };
    ...
    function Ht(t, e, n) {
        return t.map((function(t) {
            return function(t, e, n) {
                ...
                var i = n.getElementById(r.r), o = i && i.querySelectorAll("stop") || [];
    ...
    function Xt(t, e, r, i, o, u, a, l) {
        return Ht(t, 0, l), e = function(t, e, n) {
            ...
            if("g" === o.t) {
                ...
                return function(t, e) {
                    ...
                    for(var o = 0, u = n.length, a = e.length - 1; o < u; o++) n[o].setAttribute("stop-color", gt(e[Math.min(o, a)].c)), n[o].setAttribute("offset", e[Math.min(o, a)].o)
                }(u, o.s), Object.keys(Qt).forEach((function(t) {
                    if(void 0 !== o[t]) if("object" !== n(Qt[t])) {
                        var e,
            ...
            if(i === r.t) switch(n.t) {
                ...
                case"g":
                    if(n.r === r.r) {
                        ...
                        return n.gt && r.gt && (o.gt = z(t, n.gt, r.gt)), n.c ? (o.c = L(t, n.c, r.c), o.rd = C(t, n.rd, r.rd)) : n.f && (o.f = L(t, n.f, r.f), o.to = L(t, n.to, r.to)), o
                    }
            }
            if("c" === n.t && "g" === r.t || "c" === r.t && "g" === n.t) {
                var u = "c" === n.t ? n : r, a = "g" === n.t ? e({}, n) : e({}, r), l = a.s.map((function(t) {
                    return {
                        c: u.v,
                        o: t.o
                    }
                }));
                return a.s = "c" === n.t ? Kt(t, l, a.s) : Kt(t, a.s, l), a
            }
        }
        return R(t, n, r)
    }
    ...
    function ne(t, e, n) {
        ...
        for(var i, o = [], u = 0; u < r; u++) {
            ...
            if(!(i = ee[e[u].type])) return R(t, e, n);
            o.push({
                type: e.type,
    ...
    var ue = {
        ...
        "#filter": function(t, e, n, r, i, o, u, a) {
            ...
            var l = function(t, e) {
                var n = (t = t.map((function(t) {
                    return t && re[t[0]] ? (e.getElementById(t[1]), re[t[0]](e.getElementById(t[1]), t[1], e)) : null
                }))).length;
                return function(e) {
        ...
        pause: "pause",
        play: function(t, e) {
            return se(t, e.hasEnded ? "restart" : "play", e)
        },
        restart: "restart",
        reverse: function(t, e) {
            return se(t, "reverse", e, [ !0 ])
        },
        seek: "seek",
        seekBy: "seekBy",
        seekTo: "seekTo",
    ...
    var fe = function t(e) {
        ...
        var n = {}, i = [ "on", "off" ], o = {
            get: function(t, e, r) {
                return ae[e] ? "function" == typeof ae[e] ? ae[e].call(t, t, r) : t[ae[e]] : le[e] ? "function" == typeof le[e] ? le[e].call(t, t, r) : se(t, le[e], r) : -1 !== i.indexOf(e) ? n[e] : "ready" === e ? function(t) {
        ...
        var u = Object.keys(ae).concat(Object.keys(le)).concat(i), a = {};
    ...
    function ce(t) {
        ...
        this.on = function(t, n) {
            ...
            var n, r = Array.prototype.slice.call(arguments), i = r[0], o = r.slice(1);
    ...
    var he = !0, ve = [ "iterations", "speed", "fps", "direction", "fill", "alternate" ], de = function(t) {
        !function(t, e) {
        ...
        return o(u, [ {
            ...
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                    e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : he,
                    n = h(a(u.prototype), "pause", this).call(this);
                return e === he && this.trigger(t ? "end" : "pause", this.offset), n
            }
        }, {
            key: "restart",
            value: function() {
            ...
            key: "_apply",
            value: function(t) {
                var e = this, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : he,
            ...
            value: function(t) {
                ...
                if(!e) return null;
                var n = e.el, r = e.options, i = e.player, o = new fe(i), l = new ce(o);
                ...
                n.svgatorPlayer = o, function(t) {
                    var e, n,
                        r = t && 1 === (null === (e = t.ownerDocument) || void 0 === e || null === (n = e.childNodes) || void 0 === n ? void 0 : n.length) && window.parent !== window,
